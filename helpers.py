...
def get_random_roster_prompt(link_url):
    """
    Returns a friendly, unobtrusive variation of prompt to submit team roster via the bot.
    """
    templates = [
        f"Состав можно сдать через <a href=\"{link_url}\">бота в ЛС</a>",
        f"Состав на игру можно внести в <a href=\"{link_url}\">боте</a>",
        f"Если удобно, состав можно передать в <a href=\"{link_url}\">боте в ЛС</a>",
        f"Заявить игроков на игру можно в <a href=\"{link_url}\">боте</a>",
        f"Кстати, состав на этот турнир можно передать через <a href=\"{link_url}\">бота в ЛС</a>",
        f"Заявить состав команды можно в <a href=\"{link_url}\">боте</a>",
        f"Игроков команды можно заявить через <a href=\"{link_url}\">бота в ЛС</a>",
        f"Если что, состав на игру можно сдать через <a href=\"{link_url}\">бота в ЛС</a>",
        f"Внести состав команды на игру можно в <a href=\"{link_url}\">боте в ЛС</a>",
        f"Состав на турнир можно заполнить в <a href=\"{link_url}\">боте</a>",
        f"Когда определитесь с составом, его можно внести через <a href=\"{link_url}\">бота в ЛС</a>",
        f"Игроков на игру можно указать в <a href=\"{link_url}\">боте</a>",
        f"Состав команды можно заранее сдать через <a href=\"{link_url}\">бота в ЛС</a>",
        f"Заполнить состав команды можно в <a href=\"{link_url}\">боте в ЛС</a>",
        f"Указать, кто будет играть, можно прямо в <a href=\"{link_url}\">боте</a>",
        f"Игроков на этот турнир можно передать через <a href=\"{link_url}\">бота в ЛС</a>",
        f"Состав на турнир можно внести в <a href=\"{link_url}\">боте</a>",
        f"Заявить игроков на игру можно через <a href=\"{link_url}\">бота в ЛС</a>",
        f"Когда состав будет готов, его можно сдать в <a href=\"{link_url}\">боте</a>",
        f"Передать состав команды на игру можно через <a href=\"{link_url}\">бота в ЛС</a>",
        f"Состав команды на игру можно передать в <a href=\"{link_url}\">боте</a>",
        f"Заявить состав на игру можно через <a href=\"{link_url}\">бота в ЛС</a>",
        f"В <a href=\"{link_url}\">боте</a> можно указать тех, кто будет играть",
        f"Сдать состав на игру можно в <a href=\"{link_url}\">боте в ЛС</a>",
        f"Когда состав будет собран, его можно внести через <a href=\"{link_url}\">бота</a>",
        f"Игроков команды на игру можно заявить в <a href=\"{link_url}\">боте в ЛС</a>",
        f"Состав на турнир можно отправить через <a href=\"{link_url}\">бота</a>",
        f"Внести игроков команды можно в <a href=\"{link_url}\">боте в ЛС</a>",
        f"Кстати, играющий состав можно заявить в <a href=\"{link_url}\">боте</a>",
        f"Передать игроков команды можно через <a href=\"{link_url}\">бота в ЛС</a>",
        f"Состав команды можно указать в <a href=\"{link_url}\">боте</a>",
        f"Заявить состав на турнир можно через <a href=\"{link_url}\">бота в ЛС</a>",
        f"Сдать состав на игру можно прямо в <a href=\"{link_url}\">боте</a>",
        f"Указать игроков на эту игру можно через <a href=\"{link_url}\">бота в ЛС</a>",
        f"Подать состав команды можно в <a href=\"{link_url}\">боте</a>",
        f"Если хотите, игроков можно заявить через <a href=\"{link_url}\">бота в ЛС</a>",
        f"Состав на предстоящую игру можно внести в <a href=\"{link_url}\">боте</a>",
        f"Игроков команды на игру можно передать через <a href=\"{link_url}\">бота в ЛС</a>",
        f"Состав команды можно передать в <a href=\"{link_url}\">боте в ЛС</a>",
        f"В <a href=\"{link_url}\">боте в ЛС</a> можно указать, кто будет играть",
        f"Заполнить состав можно прямо в <a href=\"{link_url}\">боте</a>",
        f"Состав на игру можно передать через <a href=\"{link_url}\">бота в ЛС</a>",
        f"Указать играющий состав можно в <a href=\"{link_url}\">боте</a>",
        f"Перед началом игры состав можно внести через <a href=\"{link_url}\">бота в ЛС</a>",
        f"Игроков на игру можно заявить в <a href=\"{link_url}\">боте</a>",
        f"Состав на турнир можно передать через <a href=\"{link_url}\">бота в ЛС</a>",
        f"В <a href=\"{link_url}\">боте</a> можно заявить состав на этот турнир",
        f"Когда состав будет известен, его можно внести в <a href=\"{link_url}\">боте в ЛС</a>",
        f"Состав на игру можно отправить через <a href=\"{link_url}\">бота</a>",
        f"Внести состав команды можно через <a href=\"{link_url}\">бота в ЛС</a>",
    ]
